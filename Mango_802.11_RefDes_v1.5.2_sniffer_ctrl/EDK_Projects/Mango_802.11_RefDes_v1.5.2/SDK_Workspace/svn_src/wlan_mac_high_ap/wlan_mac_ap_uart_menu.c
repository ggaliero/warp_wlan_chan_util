...
#define UART_MODE_INTERACTIVE_SORT						   3
...
void uart_rx(u8 rxByte){
	...
	switch(uart_mode){
		...
		// ------------------------------------------------
		// Interactive Sort User Traffic
		//
		case UART_MODE_INTERACTIVE_SORT:
			switch(rxByte){

				// ----------------------------------------
				// 'm' - Sort users by decreasing traffic
				//
				case ASCII_m:
				...
				// ----------------------------------------
				// 'p' - Sort users by decreasing rx power
				//     level
				//
				case ASCII_p:
